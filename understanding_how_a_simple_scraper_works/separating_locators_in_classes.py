...
class ParsedItemLocators:
    """
    The parsed logic should be separated from the parsed data - separating concerns.
    These can be located in another .py class file.
    """
...
class ParsedItem:
    """
    Class that takes in an HTML page or content, and find properties of an item
    in it.
    """
